...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * | Ctrl |CapWrd| Super| Alt  | Lower| Space/Shift |Raise | Left | Down |  Up  |Right |
    * `-----------------------------------------------------------------------------------'
    */
    [_BASE] = LAYOUT_grid(
        ...
        KC_LCTL, CW_TOGG, KC_LGUI, KC_LALT, MO(_LOWER), LSFT_T(KC_SPC), MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
